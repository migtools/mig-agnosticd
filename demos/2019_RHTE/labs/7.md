...
```
Once you'd found the appropriate migration execution that you want to investigate, you can request more detail:
...
The Velero CRs will contain references to the associated MigMigration.  We can use the UID of the MigMigration to query the relavent objects:
