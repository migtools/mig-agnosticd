...
$ ssh lab-user@bastion.GUID.DOMAIN
```
2. Run the following playbook to enable the proper CORS headers on the source v3.11 cluster.  Be sure to provide the GUIDs for the 3.11 and 4.1 environments.  The cors.yaml is in /scripts directory of the lab-user's home directory (`/home/lab_user/scripts`).
```
